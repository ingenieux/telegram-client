...
data class Update @JsonCreator constructor(  /** The update‘s unique identifier. Update identifiers start from a certain positive number and increase sequentially. This ID becomes especially handy if you’re using Webhooks, since it allows you to ignore repeated updates or to restore the correct update sequence, should they get out of order. **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class User @JsonCreator constructor(  /** Unique identifier for this user or bot **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Chat @JsonCreator constructor(  /** Unique identifier for this chat, not exceeding 1e13 by absolute value **/
  @param:JsonProperty("id") @get:JsonProperty("id")
  val id: Int
,
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Message @JsonCreator constructor(  /** Unique message identifier **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class MessageEntity @JsonCreator constructor(  /** Type of the entity. One of mention (@username), hashtag, bot_command, url, email, bold (bold text), italic (italic text), code (monowidth string), pre (monowidth block), text_link (for clickable text URLs) **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class PhotoSize @JsonCreator constructor(  /** Unique identifier for this file **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Audio @JsonCreator constructor(  /** Unique identifier for this file **/
  @param:JsonProperty("file_id") @get:JsonProperty("file_id")
  val fileId: String
,
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Document @JsonCreator constructor(  /** Unique file identifier **/
  @param:JsonProperty("file_id") @get:JsonProperty("file_id")
  val fileId: String
,
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Sticker @JsonCreator constructor(  /** Unique identifier for this file **/
  @param:JsonProperty("file_id") @get:JsonProperty("file_id")
  val fileId: String
,
  /** Sticker width **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Video @JsonCreator constructor(  /** Unique identifier for this file **/
  @param:JsonProperty("file_id") @get:JsonProperty("file_id")
  val fileId: String
,
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Voice @JsonCreator constructor(  /** Unique identifier for this file **/
  @param:JsonProperty("file_id") @get:JsonProperty("file_id")
  val fileId: String
,
  /** Duration of the audio in seconds as defined by sender **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Contact @JsonCreator constructor(  /** Contact's phone number **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Location @JsonCreator constructor(  /** Longitude as defined by sender **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class Venue @JsonCreator constructor(  /** Venue location **/
  @param:JsonProperty("location") @get:JsonProperty("location")
  val location: Location
,
  /** Name of the venue **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class UserProfilePhotos @JsonCreator constructor(  /** Total number of profile pictures the target user has **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class ReplyKeyboardMarkup @JsonCreator constructor(  /** Array<button> rows, each represented by an Array<KeyboardButton> objects **/
...
,
  ...
  val oneTimeKeyboard: Boolean?): ReplyMarkup


/** This object represents one button of the reply keyboard. For simple text buttons String can be used instead of this object to specify text of the button. Optional fields are mutually exclusive. **/
@JsonIgnoreProperties(ignoreUnknown=true)
data class KeyboardButton @JsonCreator constructor(  /** Text of the button. If none of the optional fields are used, it will be sent to the bot as a message when the button is pressed **/
  @param:JsonProperty("text") @get:JsonProperty("text")
  val text: String?
,
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class ReplyKeyboardHide @JsonCreator constructor(  /** Requests clients to hide the custom keyboard **/
  @param:JsonProperty("hide_keyboard") @get:JsonProperty("hide_keyboard")
  val hideKeyboard: Boolean): ReplyMarkup


/** This object represents one button of an inline keyboard. You must use exactly one of the optional fields. **/
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineKeyboardButton @JsonCreator constructor(  /** Label text on the button **/
  @param:JsonProperty("text") @get:JsonProperty("text")
  val text: String
,
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class CallbackQuery @JsonCreator constructor(  /** Unique identifier for this query **/
  @param:JsonProperty("id") @get:JsonProperty("id")
  val id: String
,
  /** Sender **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class ForceReply @JsonCreator constructor(  /** Shows reply interface to the user, as if they manually selected the bot‘s message and tapped ’Reply' **/
  @param:JsonProperty("force_reply") @get:JsonProperty("force_reply")
  val forceReply: Boolean): ReplyMarkup


/** This object represents an incoming inline query. When the user sends an empty query, your bot could return some default or trending results. **/
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQuery @JsonCreator constructor(  /** Unique identifier for this query **/
  @param:JsonProperty("id") @get:JsonProperty("id")
  val id: String
,
  /** Sender **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultArticle @JsonCreator constructor(  /** Type of the result, must be article **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
...
,
  ...
  val thumbWidth: Int?): InlineQueryResult


/** Represents a link to a photo. By default, this photo will be sent by the user with optional caption. Alternatively, you can use input_message_content to send a message with the specified content instead of the photo. **/
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultPhoto @JsonCreator constructor(  /** Type of the result, must be photo **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
,
  /** Optional. Inline keyboard attached to the message **/
  @param:JsonProperty("reply_markup") @get:JsonProperty("reply_markup")
  val replyMarkup: InlineKeyboardMarkup?): InlineQueryResult


/** Represents a link to an animated GIF file. By default, this animated GIF file will be sent by the user with optional caption. Alternatively, you can use input_message_content to send a message with the specified content instead of the animation. **/
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultGif @JsonCreator constructor(  /** Type of the result, must be gif **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultMpeg4Gif @JsonCreator constructor(  /** Type of the result, must be mpeg4_gif **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultVideo @JsonCreator constructor(  /** Type of the result, must be video **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultAudio @JsonCreator constructor(  /** Type of the result, must be audio **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultVoice @JsonCreator constructor(  /** Type of the result, must be voice **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultDocument @JsonCreator constructor(  /** Type of the result, must be document **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultLocation @JsonCreator constructor(  /** Type of the result, must be location **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 Bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultVenue @JsonCreator constructor(  /** Type of the result, must be venue **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 Bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultContact @JsonCreator constructor(  /** Type of the result, must be contact **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 Bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultCachedPhoto @JsonCreator constructor(  /** Type of the result, must be photo **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultCachedGif @JsonCreator constructor(  /** Type of the result, must be gif **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultCachedMpeg4Gif @JsonCreator constructor(  /** Type of the result, must be mpeg4_gif **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultCachedSticker @JsonCreator constructor(  /** Type of the result, must be sticker **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultCachedDocument @JsonCreator constructor(  /** Type of the result, must be document **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultCachedVideo @JsonCreator constructor(  /** Type of the result, must be video **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultCachedVoice @JsonCreator constructor(  /** Type of the result, must be voice **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InlineQueryResultCachedAudio @JsonCreator constructor(  /** Type of the result, must be audio **/
  @param:JsonProperty("type") @get:JsonProperty("type")
  val type: String
,
  /** Unique identifier for this result, 1-64 bytes **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InputTextMessageContent @JsonCreator constructor(  /** Text of the message to be sent, 1-4096 characters **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InputLocationMessageContent @JsonCreator constructor(  /** Latitude of the location in degrees **/
  @param:JsonProperty("latitude") @get:JsonProperty("latitude")
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InputVenueMessageContent @JsonCreator constructor(  /** Latitude of the venue in degrees **/
  @param:JsonProperty("latitude") @get:JsonProperty("latitude")
  val latitude: Float
,
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class InputContactMessageContent @JsonCreator constructor(  /** Contact's phone number **/
  @param:JsonProperty("phone_number") @get:JsonProperty("phone_number")
  val phoneNumber: String
,
  /** Contact's first name **/
...
@JsonIgnoreProperties(ignoreUnknown=true)
data class ChosenInlineResult @JsonCreator constructor(  /** The unique identifier for the result that was chosen **/
